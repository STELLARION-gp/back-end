...
exports.getSubscriptionHistory = exports.incrementChatbotUsage = exports.checkChatbotAccess = exports.cancelSubscription = exports.updateUserSubscription = exports.getUserSubscription = exports.getSubscriptionPlans = void 0;
...
const getSubscriptionPlans = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield db_1.default.query('SELECT * FROM subscription_plans WHERE is_active = true ORDER BY price_lkr ASC');
        // Add localized content if requested
        const plans = result.rows.map(plan => {
            const translations = planTranslations[lang];
            if (translations && translations[plan.plan_type]) {
                const localizedPlan = translations[plan.plan_type];
                return Object.assign(Object.assign({}, plan), { localized_name: localizedPlan.name, localized_description: localizedPlan.description, localized_features: localizedPlan.features });
            }
            return plan;
        });
        res.json({
...
const getUserSubscription = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userResult = yield db_1.default.query(`SELECT 
                u.subscription_plan, 
        ...
        if (user.chatbot_questions_reset_date !== today) {
            yield db_1.default.query('UPDATE users SET chatbot_questions_used = 0, chatbot_questions_reset_date = $1 WHERE id = $2', [today, actualUserId]);
...
const updateUserSubscription = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Validate plan type
        const validPlans = ['starseeker', 'galaxy_explorer', 'cosmic_voyager'];
        ...
        const userCheck = yield db_1.default.query('SELECT id FROM users WHERE id = $1', [actualUserId]);
        ...
        yield db_1.default.query(`UPDATE users 
             ...
             WHERE id = $5`, [plan_type, startDate, endDate, auto_renew, actualUserId]);
        // Create subscription record
        yield db_1.default.query(`INSERT INTO subscriptions (user_id, plan_type, status, start_date, end_date, auto_renew)
             VALUES ($1, $2, 'active', $3, $4, $5)`, [actualUserId, plan_type, startDate, endDate, auto_renew]);
        res.json({
            success: true,
    ...
    try {
        ...
        yield db_1.default.query(`UPDATE users 
             SET subscription_plan = 'starseeker',
                 ...
                 auto_renew = false,
                 updated_at = CURRENT_TIMESTAMP
             WHERE id = $1`, [actualUserId]);
        // Update current subscription record
        yield db_1.default.query(`UPDATE subscriptions 
             SET status = 'cancelled',
                 cancelled_at = CURRENT_TIMESTAMP,
                 cancellation_reason = $2,
                 updated_at = CURRENT_TIMESTAMP
             WHERE user_id = $1 AND status = 'active'`, [actualUserId, cancellation_reason]);
        res.json({
            success: true,
...
const checkChatbotAccess = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { user_id } = req.params;
        // Convert Firebase UID to integer user_id if needed
        let actualUserId;
...
const incrementChatbotUsage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { user_id } = req.params;
        // Convert Firebase UID to integer user_id if needed
        let actualUserId;
        ...
        yield db_1.default.query('UPDATE users SET chatbot_questions_used = chatbot_questions_used + 1 WHERE id = $1', [actualUserId]);
        res.json({
            success: true,
...
exports.incrementChatbotUsage = incrementChatbotUsage;
...
const getSubscriptionHistory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield db_1.default.query(`SELECT 
             ...
             WHERE s.user_id = $1
             ORDER BY s.created_at DESC`, [actualUserId]);
        res.json({
            success: true,
            data: result.rows
        });
